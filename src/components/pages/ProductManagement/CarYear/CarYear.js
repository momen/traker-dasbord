...
function CarYear() {
  ...
  const [sortModel, setSortModel] = useState([{ field: "year", sort: "desc" }]);
  ...
  return (
    <React.Fragment>
      ...
      >
        ...
        <DialogContent>
          <DialogContentText id="alert-dialog-description">
            Are you sure you want to delete this Year? <br />
      ...
      >
        ...
        <DialogContent>
          <DialogContentText id="alert-dialog-description">
            Are you sure you want to delete all the selected Years? <br />
